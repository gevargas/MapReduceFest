...
public class CartesianInputFormat extends FileInputFormat
{
	...
	private InputSplit[] getInputSplits(JobConf conf, String inputFormatClass, String inputPath, int numSplits) throws IOException
	{
		// Create a new instance of the input format
		FileInputFormat inputFormat = Utils.newFileInputFormat(inputFormatClass, conf);
